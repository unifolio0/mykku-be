...
enum class FeedErrorCode(
    ...
    FEED_FORBIDDEN_ACCESS(HttpStatus.FORBIDDEN, "피드에 접근할 권한이 없습니다"),
    ...
    FEED_IMAGE_NOT_FOUND(HttpStatus.BAD_REQUEST, "삭제할 이미지를 찾을 수 없습니다"),
    ...
    FEED_COMMENT_FORBIDDEN_ACCESS(HttpStatus.FORBIDDEN, "피드 댓글에 접근할 권한이 없습니다"),
