...
interface DailyMessageCommentRepository : JpaRepository<DailyMessageComment, Long> {
    ...
    fun findByDailyMessageIdAndParentCommentIsNull(dailyMessageId: Long, pageable: org.springframework.data.domain.Pageable): org.springframework.data.domain.Page<DailyMessageComment>
