...
interface ContestParticipationRepository {
    ...
    fun findContestsByMemberId(memberId: String, pageable: Pageable): Page<Contest>
    fun findByMemberIdAndContestIds(memberId: String, contestIds: List<ContestId>): List<ContestParticipation>
    fun existsByMemberIdAndContestId(memberId: String, contestId: ContestId): Boolean
    fun existsByMemberIdAndContestIdAndFeedId(memberId: String, contestId: ContestId, feedId: Long): Boolean
