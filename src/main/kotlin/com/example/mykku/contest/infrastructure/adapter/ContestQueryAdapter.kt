...
class ContestQueryAdapter(
    ...
    override fun getContestById(contestId: Long): Contest {
        return contestRepository.findByIdOrNull(contestId)
            ?: throw ContestException.contestNotFound()
    }

    override fun getProcessingContestPreviews(): List<ContestPreviewResponse> {
    ...
    override fun getContestsWithPagination(
    ...
    override fun getContestByIdWithRelations(contestId: Long): Contest {
        return contestRepository.findByIdOrNull(contestId)
            ?: throw ContestException.contestNotFound()
    }

    override fun getContestImages(contests: List<Contest>): Map<Long, List<ContestImage>> {
        val images = contestImageRepository.findByContestIn(contests)
        return images.groupBy { it.contest.id!! }
    }

    override fun getContestTags(contests: List<Contest>): Map<Long, List<ContestTag>> {
    ...
    override fun getActiveContestsWithAllTags(): List<Pair<Contest, Set<String>>> {
