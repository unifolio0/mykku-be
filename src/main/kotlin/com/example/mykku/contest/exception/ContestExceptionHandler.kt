...
class ContestExceptionHandler {

    private val logger = LoggerFactory.getLogger(ContestExceptionHandler::class.java)

    @ExceptionHandler(ContestException::class)
    fun handleContestException(exception: ContestException): ResponseEntity<ErrorResponse> {
