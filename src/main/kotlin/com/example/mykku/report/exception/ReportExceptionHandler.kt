...
class ReportExceptionHandler {
    ...
    private val logger = LoggerFactory.getLogger(ReportExceptionHandler::class.java)

    @ExceptionHandler(ReportException::class)
    fun handleReportException(exception: ReportException): ResponseEntity<ErrorResponse> {
