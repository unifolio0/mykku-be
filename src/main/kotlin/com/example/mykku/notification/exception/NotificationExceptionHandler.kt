...
class NotificationExceptionHandler {
    ...
    private val logger = LoggerFactory.getLogger(NotificationExceptionHandler::class.java)

    @ExceptionHandler(NotificationException::class)
    fun handleNotificationException(exception: NotificationException): ResponseEntity<ErrorResponse> {
