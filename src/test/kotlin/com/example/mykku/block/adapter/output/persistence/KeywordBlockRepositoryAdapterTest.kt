...
class KeywordBlockRepositoryAdapterTest : BaseRepositoryTest() {
    ...
    inner class Save {
        ...
        fun saveNewKeywordBlock() {
            val member = createAndSaveMember(id = "sv_m1", email = "sv_m1@test.com", socialId = "sv_s1")
    ...
    inner class FindById {
        ...
        fun findByExistingId() {
            val member = createAndSaveMember(id = "fbi_m1", email = "fbi_m1@test.com", socialId = "fbi_s1")
    ...
    inner class FindByMemberIdAndKeyword {
        ...
        fun findByMemberIdAndKeyword() {
            val member = createAndSaveMember(id = "fmk_m1", email = "fmk_m1@test.com", socialId = "fmk_s1")
        ...
        fun findByNonExistingMemberIdAndKeyword() {
            val foundKeywordBlock = keywordBlockRepository.findByMemberIdAndKeyword("non_existing", "keyword")
    ...
    inner class ExistsByMemberIdAndKeyword {
        ...
        fun existsByMemberIdAndKeyword() {
            val member = createAndSaveMember(id = "ex_m1", email = "ex_m1@test.com", socialId = "ex_s1")
            keywordBlockRepository.save(createKeywordBlock(memberId = member.id, keyword = "스포일러"))
        ...
        fun notExistsByMemberIdAndKeyword() {
            val exists = keywordBlockRepository.existsByMemberIdAndKeyword("ne_member", "스포일러")
    ...
    inner class FindAllByMemberId {
        ...
        fun findAllByMemberId() {
            val member1 = createAndSaveMember(id = "fa_m1", email = "fa_m1@test.com", socialId = "fa_s1")
            val member2 = createAndSaveMember(id = "fa_m2", email = "fa_m2@test.com", socialId = "fa_s2")
        ...
        fun findAllByMemberIdWhenEmpty() {
            val pageable = PageRequest.of(0, 10)
            val page = keywordBlockRepository.findAllByMemberId("non_existing", pageable)
        ...
        fun findAllByMemberIdWithPaging() {
            val member = createAndSaveMember(id = "pg_m1", email = "pg_m1@test.com", socialId = "pg_s1")
            for (i in 1..5) {
    ...
    inner class FindKeywordsByMemberId {
        ...
        fun findKeywordsByMemberId() {
            val member1 = createAndSaveMember(id = "fk_m1", email = "fk_m1@test.com", socialId = "fk_s1")
            val member2 = createAndSaveMember(id = "fk_m2", email = "fk_m2@test.com", socialId = "fk_s2")
        ...
        fun findKeywordsByMemberIdWhenEmpty() {
            val keywords = keywordBlockRepository.findKeywordsByMemberId("non_existing")
    ...
    inner class CountByMemberId {
        ...
        fun countByMemberId() {
            val member = createAndSaveMember(id = "ct_m1", email = "ct_m1@test.com", socialId = "ct_s1")
        ...
        fun countByMemberIdWhenEmpty() {
            val count = keywordBlockRepository.countByMemberId("non_existing")
    ...
    inner class Delete {
        ...
        fun deleteKeywordBlock() {
            val member = createAndSaveMember(id = "dl_m1", email = "dl_m1@test.com", socialId = "dl_s1")
            val savedKeywordBlock = keywordBlockRepository.save(createKeywordBlock(memberId = member.id))
    ...
    inner class DeleteByMemberIdAndKeyword {
        ...
        fun deleteByMemberIdAndKeyword() {
            val member = createAndSaveMember(id = "dk_m1", email = "dk_m1@test.com", socialId = "dk_s1")
            keywordBlockRepository.save(createKeywordBlock(memberId = member.id, keyword = "스포일러"))
        ...
        fun deleteByNonExistingMemberIdAndKeyword() {
            keywordBlockRepository.deleteByMemberIdAndKeyword("non_existing", "keyword")
        }
    }
}
