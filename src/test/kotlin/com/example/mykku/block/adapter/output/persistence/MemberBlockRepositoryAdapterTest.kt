...
class MemberBlockRepositoryAdapterTest : BaseRepositoryTest() {
    ...
    inner class Save {
        ...
        fun saveNewMemberBlock() {
            val blocker = createAndSaveMember(id = "sv_blker1", email = "sv_blker1@test.com", socialId = "sv_s1")
            val blocked = createAndSaveMember(id = "sv_blked1", email = "sv_blked1@test.com", socialId = "sv_s2")
    ...
    inner class FindById {
        ...
        fun findByExistingId() {
            val blocker = createAndSaveMember(id = "fbi_blker1", email = "fbi_blker1@test.com", socialId = "fbi_s1")
            val blocked = createAndSaveMember(id = "fbi_blked1", email = "fbi_blked1@test.com", socialId = "fbi_s2")
    ...
    inner class FindByBlockerIdAndBlockedId {
        ...
        fun findByBlockerIdAndBlockedId() {
            val blocker = createAndSaveMember(id = "fbb_blker1", email = "fbb_blker1@test.com", socialId = "fbb_s1")
            val blocked = createAndSaveMember(id = "fbb_blked1", email = "fbb_blked1@test.com", socialId = "fbb_s2")
        ...
        fun findByNonExistingBlockerIdAndBlockedId() {
            val foundMemberBlock = memberBlockRepository.findByBlockerIdAndBlockedId("non_existing", "blocked")
    ...
    inner class ExistsByBlockerIdAndBlockedId {
        ...
        fun existsByBlockerIdAndBlockedId() {
            val blocker = createAndSaveMember(id = "ex_blker1", email = "ex_blker1@test.com", socialId = "ex_s1")
            val blocked = createAndSaveMember(id = "ex_blked1", email = "ex_blked1@test.com", socialId = "ex_s2")
        ...
        fun notExistsByBlockerIdAndBlockedId() {
            val exists = memberBlockRepository.existsByBlockerIdAndBlockedId("ne_blocker1", "ne_blocked1")
    ...
    inner class FindAllByBlockerId {
        ...
        fun findAllByBlockerId() {
            val blocker1 = createAndSaveMember(id = "fa_blker1", email = "fa_blker1@test.com", socialId = "fa_s1")
            val blocker2 = createAndSaveMember(id = "fa_blker2", email = "fa_blker2@test.com", socialId = "fa_s2")
            val blocked1 = createAndSaveMember(id = "fa_blked1", email = "fa_blked1@test.com", socialId = "fa_s3")
            val blocked2 = createAndSaveMember(id = "fa_blked2", email = "fa_blked2@test.com", socialId = "fa_s4")
            val blocked3 = createAndSaveMember(id = "fa_blked3", email = "fa_blked3@test.com", socialId = "fa_s5")
        ...
        fun findAllByBlockerIdWhenEmpty() {
            val pageable = PageRequest.of(0, 10)
            val page = memberBlockRepository.findAllByBlockerId("fae_none", pageable)
        ...
        fun findAllByBlockerIdWithPaging() {
            val blocker = createAndSaveMember(id = "pg_blker1", email = "pg_blker1@test.com", socialId = "pg_s1")
            for (i in 1..5) {
                val blocked = createAndSaveMember(id = "pg_blked$i", email = "pg_blked$i@test.com", socialId = "pg_sb$i")
                memberBlockRepository.save(createMemberBlock(blockerId = blocker.id, blockedId = blocked.id))
            }
    ...
    inner class FindBlockedIdsByBlockerId {
        ...
        fun findBlockedIdsByBlockerId() {
            val blocker1 = createAndSaveMember(id = "fbd_blker1", email = "fbd_blker1@test.com", socialId = "fbd_s1")
            val blocker2 = createAndSaveMember(id = "fbd_blker2", email = "fbd_blker2@test.com", socialId = "fbd_s2")
            val blocked1 = createAndSaveMember(id = "fbd_blked1", email = "fbd_blked1@test.com", socialId = "fbd_s3")
            val blocked2 = createAndSaveMember(id = "fbd_blked2", email = "fbd_blked2@test.com", socialId = "fbd_s4")
            val blocked3 = createAndSaveMember(id = "fbd_blked3", email = "fbd_blked3@test.com", socialId = "fbd_s5")
        ...
        fun findBlockedIdsByBlockerIdWhenEmpty() {
            val blockedIds = memberBlockRepository.findBlockedIdsByBlockerId("fbde_none")
    ...
    inner class FindBlockerIdsByBlockedId {
        ...
        fun findBlockerIdsByBlockedId() {
            val blocker1 = createAndSaveMember(id = "fbr_blker1", email = "fbr_blker1@test.com", socialId = "fbr_s1")
            val blocker2 = createAndSaveMember(id = "fbr_blker2", email = "fbr_blker2@test.com", socialId = "fbr_s2")
            val blocker3 = createAndSaveMember(id = "fbr_blker3", email = "fbr_blker3@test.com", socialId = "fbr_s3")
            val blocked1 = createAndSaveMember(id = "fbr_blked1", email = "fbr_blked1@test.com", socialId = "fbr_s4")
            val blocked2 = createAndSaveMember(id = "fbr_blked2", email = "fbr_blked2@test.com", socialId = "fbr_s5")
        ...
        fun findBlockerIdsByBlockedIdWhenEmpty() {
            val blockerIds = memberBlockRepository.findBlockerIdsByBlockedId("fbre_none")
    ...
    inner class CountByBlockerId {
        ...
        fun countByBlockerId() {
            val blocker = createAndSaveMember(id = "ct_blker1", email = "ct_blker1@test.com", socialId = "ct_s1")
            val blocked1 = createAndSaveMember(id = "ct_blked1", email = "ct_blked1@test.com", socialId = "ct_s2")
            val blocked2 = createAndSaveMember(id = "ct_blked2", email = "ct_blked2@test.com", socialId = "ct_s3")
            val blocked3 = createAndSaveMember(id = "ct_blked3", email = "ct_blked3@test.com", socialId = "ct_s4")
        ...
        fun countByBlockerIdWhenEmpty() {
            val count = memberBlockRepository.countByBlockerId("cte_none")
    ...
    inner class Delete {
        ...
        fun deleteMemberBlock() {
            val blocker = createAndSaveMember(id = "dl_blker1", email = "dl_blker1@test.com", socialId = "dl_s1")
            val blocked = createAndSaveMember(id = "dl_blked1", email = "dl_blked1@test.com", socialId = "dl_s2")
    ...
    inner class DeleteByBlockerIdAndBlockedId {
        ...
        fun deleteByBlockerIdAndBlockedId() {
            val blocker = createAndSaveMember(id = "dbb_blker1", email = "dbb_blker1@test.com", socialId = "dbb_s1")
            val blocked = createAndSaveMember(id = "dbb_blked1", email = "dbb_blked1@test.com", socialId = "dbb_s2")
        ...
        fun deleteByNonExistingBlockerIdAndBlockedId() {
            memberBlockRepository.deleteByBlockerIdAndBlockedId("dne_none", "dne_blocked")
        }
    }
}
