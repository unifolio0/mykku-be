...
class BlockDocumentTest : BaseDocumentTest() {
    ...
    inner class BlockMember {
        ...
        fun `성공`() {
            ...
            val response = MemberBlockResponse(
                id = 1L,
            ...
            `when`(blockService.blockMember(any(), any())).thenReturn(response)
        ...
        fun `자기 자신 차단 에러`() {
            ...
            `when`(blockService.blockMember(any(), any()))
    ...
    inner class UnblockMember {
        ...
        fun `차단 정보를 찾을 수 없음`() {
            ...
            `when`(blockService.unblockMember(any(), any()))
    ...
    inner class GetMemberBlocks {
        ...
        @Test
        fun `성공`() {
            val response = MemberBlockListResponse(
                blocks = listOf(
                    MemberBlockResponse(
                        id = 1L,
            ...
            `when`(blockService.getMemberBlocks(any(), any())).thenReturn(response)
    ...
    inner class BlockKeyword {
        ...
        fun `성공`() {
            ...
            val response = KeywordBlockResponse(
                id = 1L,
                keyword = "스포일러",
                blockedAt = LocalDateTime.now()
            )

            `when`(blockService.blockKeyword(any(), any())).thenReturn(response)
        ...
        fun `빈 키워드 에러`() {
            ...
            `when`(blockService.blockKeyword(any(), any()))
    ...
    inner class UnblockKeyword {
        ...
        fun `키워드 차단 정보를 찾을 수 없음`() {
            ...
            `when`(blockService.unblockKeyword(any(), any()))
    ...
    inner class GetKeywordBlocks {
        ...
        @Test
        fun `성공`() {
            val response = KeywordBlockListResponse(
                blocks = listOf(
                    KeywordBlockResponse(
                        id = 1L,
                        keyword = "스포일러",
                        blockedAt = LocalDateTime.now()
                    ),
            ...
            `when`(blockService.getKeywordBlocks(any(), any())).thenReturn(response)
