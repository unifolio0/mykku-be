...
class ScrapDocumentTest : BaseDocumentTest() {
    ...
    inner class SaveFeed {
        ...
        fun `성공`() {
            val feedId = 1L
            val request = SaveFeedWebRequest(folderId = 1L)

            doNothing().`when`(saveFeedUseCase).saveFeed(any())
        ...
        fun `이미 저장된 경우`() {
            ...
            `when`(saveFeedUseCase.saveFeed(any()))
    ...
    inner class UnsaveFeed {
        ...
        fun `성공`() {
            ...
            doNothing().`when`(saveFeedUseCase).unsaveFeed(any())
        ...
        fun `저장된 피드를 찾을 수 없음`() {
            ...
            `when`(saveFeedUseCase.unsaveFeed(any()))
    ...
    inner class GetSavedFeedList {
        ...
        fun `성공`() {
            ...
            val content = listOf(
                SaveFeedResult(id = 1L, feedId = 10L, folderId = 1L, folderName = "덕질 자료"),
                SaveFeedResult(id = 2L, feedId = 20L, folderId = 1L, folderName = "덕질 자료")
            )
            val page = PageImpl(content, pageable, content.size.toLong())

            `when`(saveFeedUseCase.getSavedFeeds(any())).thenReturn(page)
    ...
    inner class UpdateSaveFeedFolder {
        ...
        fun `성공`() {
            val feedId = 1L
            val request = UpdateSaveFeedFolderWebRequest(folderId = 2L)

            doNothing().`when`(saveFeedUseCase).updateSaveFeedFolder(any())
    ...
    inner class SaveDailyMessage {
        ...
        fun `성공`() {
            ...
            doNothing().`when`(saveDailyMessageUseCase).saveDailyMessage(any())
        ...
        fun `이미 저장된 경우`() {
            ...
            `when`(saveDailyMessageUseCase.saveDailyMessage(any()))
    ...
    inner class UnsaveDailyMessage {
        ...
        fun `성공`() {
            ...
            doNothing().`when`(saveDailyMessageUseCase).unsaveDailyMessage(any())
        ...
        fun `저장된 하루덕담을 찾을 수 없음`() {
            ...
            `when`(saveDailyMessageUseCase.unsaveDailyMessage(any()))
    ...
    inner class GetSavedDailyMessageList {
        ...
        fun `성공`() {
            val pageable = PageRequest.of(0, 20)
            val content = listOf(
                SaveDailyMessageResult(id = 1L, dailyMessageId = 10L),
                SaveDailyMessageResult(id = 2L, dailyMessageId = 20L)
            )
            val page = PageImpl(content, pageable, content.size.toLong())

            `when`(saveDailyMessageUseCase.getSavedDailyMessages(any())).thenReturn(page)
    ...
    inner class SaveEvent {
        ...
        fun `성공`() {
            ...
            doNothing().`when`(saveEventUseCase).saveEvent(any())
        ...
        fun `이미 저장된 경우`() {
            ...
            `when`(saveEventUseCase.saveEvent(any()))
    ...
    inner class UnsaveEvent {
        ...
        fun `성공`() {
            ...
            doNothing().`when`(saveEventUseCase).unsaveEvent(any())
        ...
        fun `저장된 이벤트를 찾을 수 없음`() {
            ...
            `when`(saveEventUseCase.unsaveEvent(any()))
    ...
    inner class GetSavedEventList {
        ...
        fun `성공`() {
            val pageable = PageRequest.of(0, 20)
            val content = listOf(
                SaveEventResult(id = 1L, eventId = 10L),
                SaveEventResult(id = 2L, eventId = 20L)
            )
            val page = PageImpl(content, pageable, content.size.toLong())

            `when`(saveEventUseCase.getSavedEvents(any())).thenReturn(page)
    ...
    inner class SaveFanNote {
        ...
        fun `성공`() {
            ...
            doNothing().`when`(saveFanNoteUseCase).saveFanNote(any())
        ...
        fun `이미 저장된 경우`() {
            ...
            `when`(saveFanNoteUseCase.saveFanNote(any()))
    ...
    inner class UnsaveFanNote {
        ...
        fun `성공`() {
            ...
            doNothing().`when`(saveFanNoteUseCase).unsaveFanNote(any())
        ...
        fun `저장된 덕질노트를 찾을 수 없음`() {
            ...
            `when`(saveFanNoteUseCase.unsaveFanNote(any()))
    ...
    inner class GetSavedFanNoteList {
        ...
        fun `성공`() {
            val pageable = PageRequest.of(0, 20)
            val content = listOf(
                SaveFanNoteResult(id = 1L, fanNoteId = 10L),
                SaveFanNoteResult(id = 2L, fanNoteId = 20L)
            )
            val page = PageImpl(content, pageable, content.size.toLong())

            `when`(saveFanNoteUseCase.getSavedFanNotes(any())).thenReturn(page)
